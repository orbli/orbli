...
We'll start with the human side—how trading desks organize roles—then show how good software architecture mirrors these same principles.

---

## Table of Contents

### Part 1: The Human Side
1. [Roles on a Trading Desk](#roles-on-a-trading-desk)
2. [Deep Dive: Portfolio Manager Expertise](#deep-dive-portfolio-manager-expertise)
3. [Deep Dive: Risk Manager Expertise](#deep-dive-risk-manager-expertise)
4. [Deep Dive: Trader Expertise](#deep-dive-trader-expertise)

### Part 2: The Software Architecture
5. [The Four Levels of Abstraction](#the-four-levels-of-abstraction)
6. [Level 1: Risk Management (Not Allocation!)](#level-1-risk-management-not-allocation)
7. [Level 2: Signal Generation](#level-2-signal-generation)
8. [Level 3: Order Management](#level-3-order-management)
9. [Level 4: Market Access](#level-4-market-access)
10. [The OMS and PMS: Bookkeeping Layers](#the-oms-and-pms-bookkeeping-layers)

### Part 3: Advanced Topics
11. [Rule-Based vs Statistical Approaches](#rule-based-vs-statistical-approaches)
12. [Backtesting: Matching Fidelity to Purpose](#backtesting-matching-fidelity-to-purpose)
13. [Continuous Signals and Position Sizing](#continuous-signals-and-position-sizing)
14. [Adaptive Risk Systems](#adaptive-risk-systems)
...
## Roles on a Trading Desk

Before diving into code, let's understand how trading desks organize human roles. Good software architecture mirrors this structure because both solve the same problem: **separation of concerns and clear accountability**.
...
Now that we understand how humans organize trading operations, let's see how software should mirror these same principles.
